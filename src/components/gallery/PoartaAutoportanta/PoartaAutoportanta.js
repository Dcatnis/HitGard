...
function PoartaAutoportanta (){

    let Images=[ 
    "images/tab4/gard4-tab4.png" ,
    "images/tab4/gard2-tab4.png" ,
    "images/tab4/gard3-tab4.png" ,
    "images/tab4/gard5-tab4.png" ,
    "images/tab4/gard1-tab4.png" ]
...
export default PoartaAutoportanta ;